...
run("screen='settings';routeId='전체';render()");assert(!els.app.innerHTML.includes('로그인·온보딩 다시 체험하기'));run("screen='explore';render()");assert(!els.app.innerHTML.includes('메이트 피부과'));assert(els.app.innerHTML.includes('라움 피부과'));
