...
assert(els.app.innerHTML.includes('맞춤 시술 추천받기'));assert(!els.app.innerHTML.includes('추천 이어보기'));assert(els.app.innerHTML.includes('제모 시술 모음'));assert(els.app.innerHTML.includes('브라질리언왁싱'));assert(els.app.innerHTML.includes('레이저 제모'));assert(els.app.innerHTML.includes('images.unsplash.com'));assert(!els.app.innerHTML.includes('피부 고민 노트'));
